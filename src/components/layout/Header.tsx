            ...
            <div className="flex items-center justify-between px-8 h-full">
                <div className="flex items-center gap-3 group">
                    <div className="relative">
                        <svg width="28" height="36" viewBox="0 0 21 30" fill="none" className="drop-shadow-lg transition-transform group-hover:scale-110">
                            <path d="M10.5 0L0 7.5V22.5L10.5 30L21 22.5V7.5L10.5 0Z" fill="#FFCF55" />
                            <path d="M10.5 6L4 10.5V19.5L10.5 24L17 19.5V10.5L10.5 6Z" fill="#FFA500" opacity="0.6" />
                        </svg>
                        <div className="absolute inset-0 bg-yellow-300 blur-xl opacity-30 group-hover:opacity-50 transition-opacity"></div>
                    </div>
                    <span className="text-white text-xl font-semibold tracking-wide">Công ty ABC</span>
                </div>
