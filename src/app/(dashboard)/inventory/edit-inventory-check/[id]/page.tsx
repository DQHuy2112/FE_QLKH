...
export default function EditInventoryCheck() {
                    ...
                    <div className="border-4 border-blue-600 bg-gray-100 p-6 mb-6 rounded">
                        ...
                        <div className="grid grid-cols-2 gap-x-12 gap-y-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <input
                                    type="text"
                                    defaultValue="BKKK001234"
                                    className="flex-1 px-3 py-1.5 border border-gray-400 rounded focus:outline-none focus:ring-2 focus:ring-blue-500 bg-gray-200"
                                    readOnly
                                />
                            </div>
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <textarea
                                    defaultValue="Kiểm tra đơn kỹ thuật tháng 10/2022"
                                ...
                                {products.map((product) => (
                                    <tr key={product.id} className="border border-gray-400 h-12 hover:bg-gray-50">
                                        ...
                                        <td className="px-2 text-center text-sm border-r border-gray-400">
                                            <input
                                                type="text"
                                                defaultValue={product.actualQty}
                                                className="w-full text-center border-0 focus:outline-none focus:ring-1 focus:ring-blue-500"
                                            />
                                        </td>
