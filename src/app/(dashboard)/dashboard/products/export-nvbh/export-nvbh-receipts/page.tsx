...
const mockData: ExportRecord[] = [
    ...
    { id: 2, code: 'XXXXXX', employee: 'Nguyễn Văn B', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'exported' },
    ...
    { id: 7, code: 'XXXXXX', employee: 'Nguyễn Văn G', value: '50.000.000', datetime: '10/11/2022  16:08', status: 'exported' },
    ...
    { id: 10, code: 'XXXXXX', employee: 'Nguyễn Văn K', value: '50.000.000', datetime: '10/11/2022  08:30', status: 'exported' },
    { id: 11, code: 'XXXXXX', employee: 'Nguyễn Văn L', value: '50.000.000', datetime: '09/11/2022  17:27', status: 'exported' },
    { id: 12, code: 'XXXXXX', employee: 'Nguyễn Văn M', value: '50.000.000', datetime: '09/11/2022  07:30', status: 'returned' },
    { id: 13, code: 'XXXXXX', employee: 'Nguyễn Văn N', value: '50.000.000', datetime: '08/11/2022  15:30', status: 'exported' },
];
...
export default function PhieuXuatKhoNVBH() {
                                    ...
                                    <tr key={record.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors h-[48px]">
                                        ...
                                        <td className="px-4">
                                            <div className="flex items-center justify-center gap-3">
                                                <button
                                                    onClick={() => router.push(`/dashboard/products/export-nvbh/view-export-nvbh-receipt/${record.id}`)}
                                                ...
                                                <button
                                                    onClick={() => router.push(`/dashboard/products/export-nvbh/edit-export-nvbh-receipt/${record.id}`)}
                                                    className="hover:scale-110 transition-transform"
                                                    title="Chỉnh sửa"
                                                >
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
