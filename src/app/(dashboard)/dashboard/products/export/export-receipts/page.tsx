...
const mockData: ExportRecord[] = [
    { id: 1, code: 'XXXXXX', recipient: 'Nhà cung cấp A', value: '50.000.000', datetime: '13/11/2022  15:30', status: 'pending', type: 'supplier' },
    { id: 2, code: 'XXXXXX', recipient: 'Nhà cung cấp B', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'exported', type: 'supplier' },
    { id: 3, code: 'XXXXXX', recipient: 'Nhà cung cấp C', value: '50.000.000', datetime: '12/11/2022  14:30', status: 'pending', type: 'supplier' },
    { id: 4, code: 'XXXXXX', recipient: 'Nhà cung cấp A', value: '50.000.000', datetime: '12/11/2022  12:30', status: 'rejected', type: 'supplier' },
    { id: 5, code: 'XXXXXX', recipient: 'Nhà cung cấp D', value: '50.000.000', datetime: '12/11/2022  09:30', status: 'approved', type: 'supplier' },
    { id: 6, code: 'XXXXXX', recipient: 'Nhà cung cấp B', value: '50.000.000', datetime: '11/11/2022  15:30', status: 'approved', type: 'supplier' },
    { id: 7, code: 'XXXXXX', recipient: 'Nhà cung cấp A', value: '50.000.000', datetime: '10/11/2022  16:08', status: 'exported', type: 'supplier' },
    { id: 8, code: 'XXXXXX', recipient: 'Nhà cung cấp E', value: '50.000.000', datetime: '10/11/2022  15:05', status: 'approved', type: 'supplier' },
    { id: 9, code: 'XXXXXX', recipient: 'Nhà cung cấp E', value: '50.000.000', datetime: '10/11/2022  09:55', status: 'rejected', type: 'supplier' },
    { id: 10, code: 'XXXXXX', recipient: 'Nhà cung cấp A', value: '50.000.000', datetime: '10/11/2022  08:30', status: 'exported', type: 'supplier' },
    { id: 11, code: 'XXXXXX', recipient: 'Nhà cung cấp A', value: '50.000.000', datetime: '09/11/2022  17:27', status: 'exported', type: 'supplier' },
    { id: 12, code: 'XXXXXX', recipient: 'Nhà cung cấp C', value: '50.000.000', datetime: '09/11/2022  07:30', status: 'returned', type: 'supplier' },
    { id: 13, code: 'XXXXXX', recipient: 'Nhà cung cấp F', value: '50.000.000', datetime: '08/11/2022  15:30', status: 'exported', type: 'supplier' },
    { id: 14, code: 'XXXXXX', recipient: 'Nguyễn Văn B', value: '50.000.000', datetime: '08/11/2022  12:06', status: 'exported', type: 'employee' },
    { id: 15, code: 'XXXXXX', recipient: 'Nguyễn Văn A', value: '50.000.000', datetime: '07/11/2022  09:30', status: 'exported', type: 'employee' },
];
...
export default function PhieuXuatKho() {
    const router = useRouter();
    const [data, setData] = useState<ExportRecord[]>(mockData);
            ...
            <main className="ml-[377px] mt-[113px] p-6 pr-12">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <div className="grid grid-cols-5 gap-4 mb-4">
                        ...
                        {/* Nguồn nhận */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Nguồn nhận</label>
                        ...
                        <table className="w-full table-fixed">
                            ...
                            <thead>
                                <tr className="bg-[#0046ff] text-white h-[48px]">
                                    ...
                                    <th className="px-4 text-center font-bold text-sm">Nguồn nhận</th>
                            ...
                            <tbody>
                                {data.map((record) => (
                                    <tr key={record.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors h-[48px]">
                                        ...
                                        <td className="px-4 text-center text-sm">{record.recipient}</td>
                                        ...
                                        <td className="px-4">
                                            <div className="flex items-center justify-center gap-3">
                                                <button
                                                    onClick={() => router.push(`/dashboard/products/export/view-export-receipt/${record.id}`)}
                                                ...
                                                <button
                                                    onClick={() => router.push(`/dashboard/products/export/edit-export-receipt/${record.id}`)}
                                                    className="hover:scale-110 transition-transform"
                                                    title="Chỉnh sửa"
                                                >
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
