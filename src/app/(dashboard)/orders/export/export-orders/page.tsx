...
type OrderStatus = 'pending' | 'approved' | 'rejected' | 'exported';
...
const mockData: ExportOrder[] = [
    { id: 1, code: 'XXXXXX', recipient: 'Bộ phận kỹ thuật', value: '50.000.000', datetime: '13/11/2022  15:30', status: 'pending' },
    { id: 2, code: 'XXXXXX', recipient: 'Bộ phận kinh doanh', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'exported' },
    { id: 3, code: 'XXXXXX', recipient: 'Bộ phận marketing', value: '50.000.000', datetime: '12/11/2022  14:30', status: 'pending' },
    { id: 4, code: 'XXXXXX', recipient: 'Bộ phận kỹ thuật', value: '50.000.000', datetime: '12/11/2022  12:30', status: 'rejected' },
    { id: 5, code: 'XXXXXX', recipient: 'Bộ phận hành chính', value: '50.000.000', datetime: '12/11/2022  09:30', status: 'approved' },
];
...
export default function InternalExportOrdersPage() {
    const router = useRouter();
    const [data, setData] = useState<ExportOrder[]>(mockData);
            ...
            <main className="ml-[377px] mt-[113px] p-6 pr-12">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <button
                            onClick={() => router.push('/dashboard/orders/export/create-export-order')}
                        ...
                        <table className="w-full table-fixed">
                            ...
                            <thead>
                                <tr className="bg-[#0046ff] text-white h-[48px]">
                                    ...
                                    <th className="px-4 text-center font-bold text-sm">Bộ phận nhận</th>
                                    ...
                                    <tr key={record.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors h-[48px]">
                                        ...
                                        <td className="px-4">
                                            <div className="flex items-center justify-center gap-3">
                                                <button
                                                    onClick={() => router.push(`/dashboard/orders/export/view-export-order/${record.id}`)}
                                                ...
                                                <button
                                                    onClick={() => router.push(`/dashboard/orders/export/edit-export-order/${record.id}`)}
                                                    className="hover:scale-110 transition-transform"
                                                    title="Chỉnh sửa"
                                                >
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
