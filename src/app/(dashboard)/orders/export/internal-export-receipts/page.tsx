...
const mockData: ExportRecord[] = [
    { id: 1, code: 'XXXXXX', recipient: 'Đại lý 1', value: '50.000.000', datetime: '13/11/2022  15:30', status: 'pending', type: 'agent' },
    { id: 2, code: 'XXXXXX', recipient: 'Đại lý 2', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'exported', type: 'agent' },
    { id: 3, code: 'XXXXXX', recipient: 'Đại lý 3', value: '50.000.000', datetime: '12/11/2022  14:30', status: 'pending', type: 'agent' },
    { id: 4, code: 'XXXXXX', recipient: 'Đại lý A', value: '50.000.000', datetime: '12/11/2022  12:30', status: 'rejected', type: 'agent' },
    { id: 5, code: 'XXXXXX', recipient: 'Đại lý D', value: '50.000.000', datetime: '12/11/2022  09:30', status: 'approved', type: 'agent' },
    { id: 6, code: 'XXXXXX', recipient: 'Đại lý B', value: '50.000.000', datetime: '11/11/2022  15:30', status: 'approved', type: 'agent' },
    { id: 7, code: 'XXXXXX', recipient: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  16:08', status: 'exported', type: 'agent' },
    { id: 8, code: 'XXXXXX', recipient: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  15:05', status: 'approved', type: 'agent' },
    { id: 9, code: 'XXXXXX', recipient: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  09:55', status: 'rejected', type: 'agent' },
    { id: 10, code: 'XXXXXX', recipient: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  08:30', status: 'exported', type: 'agent' },
    { id: 11, code: 'XXXXXX', recipient: 'Đại lý A', value: '50.000.000', datetime: '09/11/2022  17:27', status: 'exported', type: 'agent' },
    { id: 12, code: 'XXXXXX', recipient: 'Đại lý C', value: '50.000.000', datetime: '09/11/2022  07:30', status: 'returned', type: 'agent' },
    { id: 13, code: 'XXXXXX', recipient: 'Đại lý F', value: '50.000.000', datetime: '08/11/2022  15:30', status: 'exported', type: 'agent' },
];
...
export default function PhieuXuatKhoNoiBo() {
