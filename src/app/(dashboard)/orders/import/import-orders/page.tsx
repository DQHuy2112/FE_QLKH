...
const mockData: ImportOrder[] = [
    { id: 1, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '13/11/2022  15:30', status: 'pending' },
    { id: 2, code: 'XXXXXX', supplier: 'Đại lý B', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'imported' },
    { id: 3, code: 'XXXXXX', supplier: 'Đại lý C', value: '50.000.000', datetime: '12/11/2022  14:30', status: 'pending' },
    { id: 4, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '12/11/2022  12:30', status: 'rejected' },
    { id: 5, code: 'XXXXXX', supplier: 'Đại lý D', value: '50.000.000', datetime: '12/11/2022  09:30', status: 'approved' },
    { id: 6, code: 'XXXXXX', supplier: 'Đại lý B', value: '50.000.000', datetime: '11/11/2022  15:30', status: 'approved' },
    { id: 7, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  16:08', status: 'imported' },
    { id: 8, code: 'XXXXXX', supplier: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  15:05', status: 'imported' },
    { id: 9, code: 'XXXXXX', supplier: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  09:55', status: 'rejected' },
    { id: 10, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  08:30', status: 'imported' },
    { id: 11, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '09/11/2022  17:27', status: 'imported' },
    { id: 12, code: 'XXXXXX', supplier: 'Đại lý C', value: '50.000.000', datetime: '09/11/2022  07:30', status: 'imported' },
    { id: 13, code: 'XXXXXX', supplier: 'Đại lý F', value: '50.000.000', datetime: '08/11/2022  15:30', status: 'imported' },
];
...
export default function InternalImportOrdersPage() {
    const router = useRouter();
    const [data, setData] = useState<ImportOrder[]>(mockData);
