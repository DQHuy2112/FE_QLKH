...
const mockData: ImportRecord[] = [
    { id: 1, code: 'XXXXXX', supplier: 'Đại lý 1', value: '50.000.000', datetime: '13/11/2022  15:30', status: 'pending', type: 'agent' },
    { id: 2, code: 'XXXXXX', supplier: 'Đại lý 2', value: '50.000.000', datetime: '13/11/2022  11:09', status: 'imported', type: 'agent' },
    { id: 3, code: 'XXXXXX', supplier: 'Đại lý 3', value: '50.000.000', datetime: '12/11/2022  14:30', status: 'pending', type: 'agent' },
    { id: 4, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '12/11/2022  12:30', status: 'rejected', type: 'agent' },
    { id: 5, code: 'XXXXXX', supplier: 'Đại lý D', value: '50.000.000', datetime: '12/11/2022  09:30', status: 'approved', type: 'agent' },
    { id: 6, code: 'XXXXXX', supplier: 'Đại lý B', value: '50.000.000', datetime: '11/11/2022  15:30', status: 'approved', type: 'agent' },
    { id: 7, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  16:08', status: 'imported', type: 'agent' },
    { id: 8, code: 'XXXXXX', supplier: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  15:05', status: 'approved', type: 'agent' },
    { id: 9, code: 'XXXXXX', supplier: 'Đại lý E', value: '50.000.000', datetime: '10/11/2022  09:55', status: 'rejected', type: 'agent' },
    { id: 10, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '10/11/2022  08:30', status: 'imported', type: 'agent' },
    { id: 11, code: 'XXXXXX', supplier: 'Đại lý A', value: '50.000.000', datetime: '09/11/2022  17:27', status: 'imported', type: 'agent' },
    { id: 12, code: 'XXXXXX', supplier: 'Đại lý C', value: '50.000.000', datetime: '09/11/2022  07:30', status: 'returned', type: 'agent' },
    { id: 13, code: 'XXXXXX', supplier: 'Đại lý F', value: '50.000.000', datetime: '08/11/2022  15:30', status: 'imported', type: 'agent' },
];
            ...
            <main className="ml-[377px] mt-[113px] p-6 pr-12">
                ...
                <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
                    <div className="grid grid-cols-5 gap-4 mb-4">
                        ...
                        {/* Nguồn cung */}
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Nguồn cung</label>
                    ...
                    <div className="flex justify-end gap-3">
                        ...
                        <button
                            onClick={() => router.push('/dashboard/orders/import/create-internal-import-receipt')}
                        ...
                        <table className="w-full table-fixed">
                            ...
                            <thead>
                                <tr className="bg-[#0046ff] text-white h-[48px]">
                                    ...
                                    <th className="px-4 text-center font-bold text-sm">Nguồn cung</th>
                                    ...
                                    <tr key={record.id} className="border-b border-gray-200 hover:bg-gray-50 transition-colors h-[48px]">
                                        ...
                                        <td className="px-4">
                                            <div className="flex items-center justify-center gap-3">
                                                <button
                                                    onClick={() => router.push(`/dashboard/orders/import/view-internal-import-receipt/${record.id}`)}
                                                ...
                                                <button
                                                    onClick={() => router.push(`/dashboard/orders/import/edit-internal-import-receipt/${record.id}`)}
                                                    className="hover:scale-110 transition-transform"
                                                    title="Chỉnh sửa"
                                                >
                                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
